...
public class TestCase_4_2_7 {
	...
	@Test
	public void VerifyDepartmentnameandTitle() throws Exception {
		...
		Thread.sleep(3000);
		dc.Enterdepartmentname();
		dc.Enterdepartmenttitle();
		Thread.sleep(3000);
		...
		String destinationpath = System.getProperty("user.dir") + "//Screenshots//DepartmentScreenshorts//EnterNameandTitle.png";
