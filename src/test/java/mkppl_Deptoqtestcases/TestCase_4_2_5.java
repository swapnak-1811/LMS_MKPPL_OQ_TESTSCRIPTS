...
public class TestCase_4_2_5 {
	
	WebDriver driver;

	@Test(priority = 3)

	public void ClickDepartments() throws Exception {
		...
		String destinationpath = System.getProperty("user.dir") + "//Screenshots//DepartmentScreenshorts//ClickDepartments.png";
