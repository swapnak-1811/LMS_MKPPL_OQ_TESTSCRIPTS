...
public class TestCase_4_3_19 {
	...
	@Test(priority = 19)
	public void verifyUpdateButton() throws Exception {
		...
		jobcode.clickAction();
		Thread.sleep(1000);
		jobcode.clickEditButton();
		Thread.sleep(2000);
		jobcode.editResponsibility1("OQ FL Responsibility 01");
		Thread.sleep(2000);
		jobcode.editResponsibility2("OQ FL Responsibility 02");
		Thread.sleep(2000);
		JavascriptExecutor jse = (JavascriptExecutor) driver;
		jse.executeScript("document.body.style.zoom = '70%' ");
		Thread.sleep(4000);
		jobcode.editResponsibility3("OQ FL Responsibility 03");
		Thread.sleep(3000);
		jobcode.updateButton();
		Thread.sleep(2000);
		jobcode.enterAuthenticationPassword("admin");
		jobcode.clickAuthenticationSignIn();
		Thread.sleep(4000);
		...
		String destinationpath = System.getProperty("user.dir")
				+ "//Screenshots//JobcodeScreenshorts//verifyUpdateButton.png";
