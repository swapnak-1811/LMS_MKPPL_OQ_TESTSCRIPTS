...
public class TestCase_4_3_17 {
	...
	@Test(priority = 17)
	public void verifyBackButtonInViewPage() throws Exception {
		...
		jobcode.clickAction();
		Thread.sleep(1000);
		jobcode.clickViewButton();
		Thread.sleep(2000);
		jobcode.clickBackButtonInViewPage();
		Thread.sleep(3000);
		...
		String destinationpath = System.getProperty("user.dir")
				+ "//Screenshots//JobcodeScreenshorts//verifyBackButtonInViewPage.png";
