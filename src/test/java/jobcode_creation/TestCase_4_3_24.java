...
WebDriver driver;
	...
	@Test(priority=24)
	public void verifyTheUsernamebutton() throws Exception {
		...
		String destinationpath = System.getProperty("user.dir") + "//Screenshots//JobcodeScreenshorts//verifyTheUsernamebutton.png";
